...
### Run in Google Colab
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR_USERNAME/research-jumpstart/blob/main/projects/astronomy/sky-survey/tier-0/exoplanet-transit-detection.ipynb)

### Run in SageMaker Studio Lab
[![Open in SageMaker Studio Lab](https://studiolab.sagemaker.aws/studiolab.svg)](https://studiolab.sagemaker.aws/import/github/YOUR_USERNAME/research-jumpstart/blob/main/projects/astronomy/sky-survey/tier-0/exoplanet-transit-detection.ipynb)
...
- **Tier 1:** [Multi-survey catalog cross-matching](../tier-1/) on Studio Lab
...
- **Tier 3:** [Production-scale pipelines](../tier-3/) with full CloudFormation
...
- **Guest Investigator Program:** https://heasarc.gsfc.nasa.gov/docs/tess/
...
If you use this project or discover new planet candidates:

```bibtex
@software{research_jumpstart_tess_transit,
  title = {Exoplanet Transit Detection with TESS: Research Jumpstart},
