...
def lambda_handler(event, context):
    ...
    try:
        ...
        print("✓ Analysis complete. Results saved to DynamoDB and S3")
...
def analyze_grid_data(grid_data):
    ...
    try:
        ...
        results = {
            ...
            "time_range": {"start": grid_data[0]["timestamp"], "end": grid_data[-1]["timestamp"]},
        ...
        print(
            f"  Load: {results['load_metrics']['avg_mw']}MW avg, {results['load_metrics']['max_mw']}MW peak"
        )
