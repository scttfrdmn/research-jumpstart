...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            'body': {
                'error': str(e),
                'message': 'Variant calling failed'
            }
        }
...
def upload_to_s3(local_path: str, bucket: str, key: str) -> None:
    ...
    try:
        ...
        raise RuntimeError(f"Failed to upload {key} to {bucket}: {str(e)}")
...
def call_variants_in_region(bam_path: str, region: str, sample_id: str) -> List[Dict]:
    ...
    try:
        ...
        print(f"Error during variant calling: {str(e)}")
...
def write_variants_to_dynamodb(variants: List[Dict], sample_id: str, region: str) -> None:
    ...
    try:
        ...
        print(f"Warning: Failed to write to DynamoDB: {str(e)}")
