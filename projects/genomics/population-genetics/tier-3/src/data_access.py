...
class GenomicsDataLoader:
    ...
    def load_variants(
        ...
        try:
            ...
            with fs.open(s3_path) as f:
                vcf = allel.read_vcf(f, region=f'{chromosome}:{start}-{end}' if start and end else None)
    ...
    def query_athena(
        self,
        query: str,
        database: str = 'population_genetics_database'
    ) -> pd.DataFrame:
        """
...
def load_variants(chromosome: str, start: Optional[int] = None,
